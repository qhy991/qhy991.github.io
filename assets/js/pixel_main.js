...
class AcademicHomepage {
    ...
    showProjects() {
        const projectsText = [
            ...
            '   - GPU/NPU kernel optimization workflows',
            '   - ⭐ 7 stars, 2 forks',
            '',
            '4. Digital-CIM',
    ...
    showPublications() {
        const publicationsText = [
            'Publications (Google Scholar, 8 papers):',
            '===================',
            '1. CircuitWeave — arXiv:2607.23523',
            '2. ReasoningV — ICAIS 2025 / arXiv (8 cites)',
            '3. SOT CIM Macro — ICS Journal 2025 (3 cites)',
            '4. CircuitMind — arXiv:2504.14625 (1 cite)',
            '5. Multi-Agent Yield Analysis — DAC 2025',
            '6. Precision-Aware Bayesian Yield — DAC 2025',
            '7. Weight Mapping Multi-core CIM — DAC 2025',
            '8. Tiny NN on FPGA — AICAS 2023 (3 cites)',
            '',
