...
#### 🧠 ReasoningV: AI-Assisted Verilog Code Generation
...
<div class="project-card">
  ...
  <div class="project-features">
    ...
    <ul>
      <li>🎯 <strong>Domain-Specific Optimization:</strong> Specialized training for Verilog HDL language characteristics</li>
      <li>🔄 <strong>Hybrid Reasoning Strategy:</strong> Combines advantages of symbolic reasoning and neural network inference</li>
      <li>📊 <strong>High-Quality Output:</strong> Generated code with improved readability and correctness</li>
      <li>🚀 <strong>Efficient Deployment:</strong> Supports rapid code generation and iterative optimization</li>
    </ul>
  </div>

  <div class="project-links">
    <strong>Resources & Links:</strong><br>
    <a href="https://arxiv.org/pdf/2504.14560v3" class="btn btn-primary">📄 Paper</a>
    <a href="https://huggingface.co/datasets/GipAI/ReaoningV" class="btn btn-secondary">🤗 Dataset</a>
    <a href="https://huggingface.co/GipAI/ReasoningV-7B" class="btn btn-secondary">🤗 Model</a>
    <a href="https://modelscope.cn/datasets/GipsyAI/ReasoningV" class="btn btn-info">🌐 ModelScope Dataset</a>
    <a href="https://modelscope.cn/models/GipsyAI/ReasoningV-7B" class="btn btn-info">🌐 ModelScope Model</a>
  ...
  <div class="project-resources">
    ...
    <ul>
      <li><strong>Dataset:</strong> <a href="https://huggingface.co/datasets/GipAI/ReaoningV"><img src="https://img.shields.io/badge/HuggingFace-Dataset-blue" alt="Hugging Face Dataset"></a></li>
      <li><strong>Model:</strong> <a href="https://huggingface.co/GipAI/ReasoningV-7B"><img src="https://img.shields.io/badge/HuggingFace-Model-blue" alt="Hugging Face Model"></a></li>
      <li><strong>Dataset:</strong> <a href="https://modelscope.cn/datasets/GipsyAI/ReasoningV"><img src="https://img.shields.io/badge/ModelScope-Dataset-orange" alt="ModelScope Dataset"></a></li>
      <li><strong>Model:</strong> <a href="https://modelscope.cn/models/GipsyAI/ReasoningV-7B"><img src="https://img.shields.io/badge/ModelScope-Model-orange" alt="ModelScope Model"></a></li>
      <li><strong>Repository:</strong> <a href="https://github.com/BUAA-CLab/ReasoningV"><img src="https://img.shields.io/github/stars/BUAA-CLab/ReasoningV?style=social" alt="GitHub Stars"></a></li>
    </ul>
  </div>
</div>
...
<div class="project-card">
  ...
  <div class="project-features">
    <strong>Key Features:</strong>
    <ul>
      <li>📋 <strong>Comprehensive Test Suite:</strong> 5,000+ test cases covering various Verilog programming scenarios</li>
      <li>📊 <strong>Performance Evaluation:</strong> Metrics like SEI for comparing generated circuits against human expert tiers</li>
      <li>🏗️ <strong>Structured Organization:</strong> Problem descriptions, test code, and reference solutions</li>
      <li>🔬 <strong>Research Tool:</strong> Enables systematic evaluation of AI-generated Verilog code quality</li>
    </ul>
  </div>

  <div class="project-links">
    <a href="https://huggingface.co/datasets/hyq001/TC-Bench" class="btn btn-primary">📊 Browse Dataset</a>
    <a href="https://huggingface.co/datasets/hyq001/TC-Bench" class="btn btn-secondary">🤗 Hugging Face</a>
  </div>
</div>
